...
// Returns the private 'App\Repository\GuichetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GuichetRepository.php';

return $this->privates['App\\Repository\\GuichetRepository'] = new \App\Repository\GuichetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
