...
// Returns the private 'App\Repository\LogementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LogementRepository.php';

return $this->privates['App\\Repository\\LogementRepository'] = new \App\Repository\LogementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
