...
// Returns the private 'App\Repository\DemandeurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DemandeurRepository.php';

return $this->privates['App\\Repository\\DemandeurRepository'] = new \App\Repository\DemandeurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
