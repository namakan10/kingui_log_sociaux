...
// Returns the private 'App\Repository\TypeLogementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypeLogementRepository.php';

return $this->privates['App\\Repository\\TypeLogementRepository'] = new \App\Repository\TypeLogementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
